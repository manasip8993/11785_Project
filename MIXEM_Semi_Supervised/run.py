...
def main():
    ...
    config['init_from'] = '/content/drive/MyDrive/Fall 2021/18786 Introduction to Deep Learning/Project/MIXEM/STL10_800.pth'
    config['epochs'] = 2
    print('log_dir:',config['log_dir'])
    mode = 1
    train_path_clean = '/content/drive/MyDrive/Fall 2021/18786 Introduction to Deep Learning/Project/Naaye2/clean naai/'
    val_path_clean = '/content/drive/MyDrive/Fall 2021/18786 Introduction to Deep Learning/Project/Naaye2/clean naai/'
    train_path_unclean = '/content/drive/MyDrive/Fall 2021/18786 Introduction to Deep Learning/Project/Naaye2/dirty naai/'
    val_path_unclean = '/content/drive/MyDrive/Fall 2021/18786 Introduction to Deep Learning/Project/Naaye2/dirty naai/'
    
    batch_size = 512
    #tl, lt, vl, lv = our_dataloader(train_path_unclean, train_path_unclean, batch_size= batch_size, mode= 0)
    tc, vc, tu, vu = our_dataloader_new(train_path_clean, train_path_clean, train_path_unclean, train_path_unclean, batch_size= batch_size)
